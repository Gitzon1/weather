...
function App() {
  ...
  const [text, setText]= useState('Idukki');
  ...
  const search = async () => {
    ...
    let url = `https://api.openweathermap.org/data/2.5/weather?q=${text}&appid=07a4ab0909969b5e4fa41277ae3c04ba&units=Metric`;
    try {
 ...
 return (
    <>
      <div className='container'>
        ...
        <p className="copyright"><span>Ebin</span></p>
      </div>
    </>
  )
}
